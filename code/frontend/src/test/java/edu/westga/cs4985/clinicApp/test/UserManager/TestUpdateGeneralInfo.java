...
/**
 * JUnit Test Case for Update General Info
 * 
...
class TestUpdateGeneralInfo {
	...
	void testUpdateGeneralInfoSuccess() {
		...
		Patient patient = new Patient("Jimmy", "Daniels", "male", "1990-09-29", "3433 Atlanta Peachway", "",
				"Carrollton", "GA", "USA", "American Indian or Alakska Native", "Not Hispanic or Latino", "jimmy1",
				"11111", "123456789", "jimmy12334@gmail.com", "8888888888");
	...
	void testUpdateGeneralInfoFail() {
		...
		Patient patient = new Patient("Jimmy", "Daniels", "male", "1990-09-29", "3433 Atlanta Peachway", "",
				"Carrollton", "GA", "USA", "American Indian or Alakska Native", "Not Hispanic or Latino", "jimmy1",
				"11123", "123456789", "jimmy12334@gmail.com", "8888888888");
		boolean updated = userManager.updatePatientGeneralInfo(patient);
