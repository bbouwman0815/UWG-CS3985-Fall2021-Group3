...
public class NewCaregiverCodeBehind {
	
	@FXML
	private Button addCaregiver;
	...
	@FXML
	void addCaregiver(ActionEvent event) throws ParseException {
	...
	private void createMedicalPersonnel(ActionEvent event) {
		...
		Caregiver caregiver = new Caregiver(firstname, lastname, sex, birthday, address1,
				address2, city, state, country, race, ethnicity, phone, email, username, password);

		if (UserManager.userManager().addCaregiver(caregiver)) {
